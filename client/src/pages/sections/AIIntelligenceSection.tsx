  ...
  return (
    <div className="flex-grow p-6 bg-[#F8FAFC] min-h-screen">
      ...
      <div className="flex gap-5">
        ...
        <div className="flex-1 rounded-xl shadow-sm relative border border-gray-100 overflow-hidden bg-white">
          ...
          <div className="p-6 pt-5 bg-white">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 ml-7">
                <li className="flex items-start gap-2.5 text-[13px] text-gray-600 bg-[#F8FAFC] rounded-lg px-3 py-2">
