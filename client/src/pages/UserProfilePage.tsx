...
const userPosts = [
  ...
  },
  {
    id: 2,
    image:
      "https://images.unsplash.com/photo-1461151304267-38535e770f71?w=800&auto=format&fit=crop&q=60",
    type: "regular",
  },
  {
    id: 3,
...
export default function UserProfilePage() {
  ...
  return (
    <div className="flex bg-[#f5f6fa] w-full min-h-screen relative overflow-hidden">
      <Sidebar
        className="w-[280px] flex-shrink-0 sticky top-0"
        activeModule="Users"
      />
        ...
        <div className="bg-white rounded-[24px] overflow-hidden shadow-sm border border-[#0000000a]">
          ...
          <div className="px-8 pb-4 -mt-12 relative flex items-end justify-between">
            <div className="flex items-end gap-5">
              ...
              <div className="pb-2">
                <h1 className="text-2xl font-bold text-[#222f36]">
                  Siti Arlina
                </h1>
                <div className="flex items-center gap-2 mt-1">
                  <Badge
                    variant="secondary"
                    className="bg-[#f0f9ff] text-[#0284c7] border border-[#bae6fd] text-[10px] py-0.5 px-2 flex items-center gap-1 font-medium rounded-md"
                  >
                    <img
                      src="/figmaAssets/frame-1171275705.svg"
            ...
            <div className="flex items-center gap-12 pb-2">
              ...
              >
                <p className="text-xl font-bold text-[#222f36] group-hover:text-[#62a230]">
                  1.2M
                </p>
                <p className="text-[10px] text-[#7b848f] font-medium uppercase tracking-wider">
                  Followers
                </p>
              </button>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="text-[#7b848f] hover:bg-gray-100 rounded-lg"
                    >
            ...
            <Card className="border-0 shadow-sm rounded-[24px] bg-white">
              <CardContent className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  <div className="flex gap-1">
                    {[1, 2, 3, 4].map((i) => (
                      <Star
                        key={i}
                        className="w-4 h-4 fill-[#f59f00] text-[#f59f00]"
                      />
                    ))}
                    <Star className="w-4 h-4 text-[#e2e8f0]" />
                  </div>
                  <span className="text-sm font-medium text-[#7b848f]">
                    4.5
                  </span>
                </div>

                <div className="space-y-3">
                  <h3 className="text-lg font-semibold text-[#222f36]">
                    About
                  </h3>
                  <p className="text-sm text-[#7b848f] leading-relaxed">
                    Lorem ipsum dolor sit amet consectetur. Fermentum metus eget
                    eu lacus. Fermentum nunc sed dui in nisl lacinia. Odio eget
                    purus velit et sit sit scelerisque. Ac in ultrices aliquam
                    velit et volutpat.
                  </p>
                </div>
                ...
                <div className="pt-4 border-t space-y-4">
                  <h4 className="text-xs font-bold text-[#222f36] uppercase tracking-wider">
                    Contact Info
                  </h4>
                  <div className="space-y-3">
              ...
              <CardContent className="p-4 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="w-9 h-9 bg-[#f0fdf4] text-[#62a230] rounded-lg border border-[#62a230]/10"
                  >
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="w-9 h-9 text-[#7b848f] rounded-lg"
                  >
        ...
        <>
          ...
          <div className="fixed right-0 top-0 bottom-0 w-[380px] bg-white shadow-2xl z-50 flex flex-col p-6 animate-in slide-in-from-right duration-300 rounded-l-[32px]">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-[#222f36]">
                {drawerType}
              </h2>
                ...
                >
                  <div className="flex items-center gap-4">
                    <Avatar className="w-12 h-12 border-2 border-white shadow-sm ring-1 ring-gray-100">
                      <AvatarImage
                        src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${drawerType}${i}`}
                      />
                      <AvatarFallback>U</AvatarFallback>
                    </Avatar>
                    <div className="space-y-0.5">
                      <p className="text-[14px] font-bold text-[#222f36]">
                        {user.name}
                      </p>
                      <p className="text-[11px] text-[#7b848f] font-medium">
                        {user.username}
                      </p>
                    </div>
                  </div>
      ...
      <Dialog open={showBlockDialog} onOpenChange={setShowBlockDialog}>
        <DialogContent className="max-w-[480px] rounded-[24px] p-0 overflow-hidden border-none shadow-2xl bg-white [&>button]:hidden">
          <div className="p-8 space-y-6 text-center relative">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-base font-bold text-[#222f36]">
                  John Doe
                </span>
              </div>
              ...
              <p className="text-sm text-[#7b848f] leading-relaxed px-4">
                This action will temporarily restrict the user's access to
                certain features. You can unblock them at any time from the
                settings.
              </p>
            </div>
